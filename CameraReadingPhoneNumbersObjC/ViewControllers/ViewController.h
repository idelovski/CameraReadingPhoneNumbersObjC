...
@property  (assign, nonatomic)  CGAffineTransform     uiRotationTransform;
@property  (assign, nonatomic)  CGAffineTransform     bottomToTopTransform;
@property  (assign, nonatomic)  CGAffineTransform     roiToGlobalTransform;
@property  (assign, nonatomic)  CGAffineTransform     visionToAVFTransform;
