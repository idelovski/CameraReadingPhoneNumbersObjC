...
@interface StringTracker: NSObject

@property  (assign, nonatomic)  int            frameIndex;
@property  (assign, nonatomic)  int            bestCount;
@property  (strong, nonatomic)  NSString      *bestString;
@property  (strong, nonatomic)  NSMutableDictionary  *seenStrings;  // String: StringObservation
